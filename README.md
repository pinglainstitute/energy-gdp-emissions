...
If your local machine is using Apple Silicon (arm64 macos). [requirements.txt for macos](https://github.com/pinglainstitute/energy-gdp-emissions/blob/main/requirements-macos.txt)
